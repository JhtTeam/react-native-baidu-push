...
Notifications.configure = function (options: Object) {
  ...
  // remove this.hasPoppedInitialNotification logic to fix android onNotification not called when
...
Notifications._onNotification = function (data, isFromBackground = null) {
  if (isFromBackground === null) {
    isFromBackground = data.foreground === false || AppState.currentState !== 'active';
  }
